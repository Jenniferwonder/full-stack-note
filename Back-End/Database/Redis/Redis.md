...
### 学习条件  
1目标方向是后端开发或数据库、数据开发相关的岗位（前端同学先不要学了）  
2先学完一套开发框架（比如 SSM、SpringBoot），再学习 Redis  
### 学习路线  
建议大家按照以下五个阶段来学习：  
1基础入门  
2实战应用  
...
2对于初学后端的同学来说，学完第二阶段（实战应用）后就可以再去学消息队列、微服务等其他知识了。等主流的后端开发技术都会用后、面试前再回过头来补高级知识和原理即可。  
...
4如何解决缓存击穿、缓存穿透、雪崩问题？  
5如何用 Redis 实现点赞功能，怎么设计 Key / Value？  
### 资源  
#### ●视频  
